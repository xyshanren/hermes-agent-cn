...
| 文档 | 建议 | 优先级 |
|------|------|--------|
| `README.md` | 版本徽章更新为 v0.12.0-cn.3 | P3 |
| `NEXT_PLAN.md` | 内容已过时（基于 5-03 状态），建议归档或更新 | P3 |
...
2. [ ] 更新 `README.md` 版本徽章 → `v0.12.0-cn.3`
3. [ ] 整理归档 `NEXT_PLAN.md`（内容过时）
