...
> 当前规划请查阅 [DOCS-MAP.md](./DOCS-MAP.md)（文档体系总览）和 [CHANGELOG_CN.md](../CHANGELOG_CN.md)（最新变更）。
> 以下内容保留作为历史参考，不再更新。

---

**原生成时间**：2026-05-03 14:01  
**当前版本**：v0.12.0-cn.3（2026-05-13）  
**归档日期**：2026-05-13
...
| **汉化工作** | 10 | 12 | 🟢 83% |
| **测试覆盖** | 34 | 34 | 🟢 100% |
| **xb_native.py** | 5 | 5 | 🟢 100% |
| **消息渠道裁剪** | 12 | 12 | 🟢 100%（隐藏） |
| **TUI 汉化** | 5 | 5 | 🟢 100% |
| **Web Dashboard** | 342 | 342 | 🟢 100%（i18n 键） |
| **v0.12.0-cn.1 发布** | ⏳ 前置条件全部满足 | 等你通知 |
| **文档网站汉化** | 待定 | — | ⏸️ 等待用户量增长 |
| **Phase 10 结构化摘要** | 待定 | — | ⏸️ 等待用户量增长 |
| **文言试点** | 待定 | — | ⏸️ 等待三条件触发 |

---

**维护者**：xyshanren  
**最后更新**：2026-05-03 16:07
