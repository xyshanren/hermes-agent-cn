...
def coerce_message_timestamp(ts_value: Any, tz=None) -> Optional[float]:
    ...
    if isinstance(ts_value, (int, float)):
        # Milliseconds (>10B) are detected and normalized to seconds
        # (compatible with CN's existing _coerce_gateway_timestamp).
        if isinstance(ts_value, (int, float)) and ts_value > 10_000_000_000:
