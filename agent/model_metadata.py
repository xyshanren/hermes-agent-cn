...
def get_model_context_length(
    ...
    # 2. Novita AI provider check — uses endpoint metadata API.
    ...
    # 3. Local server query — runs BEFORE custom-endpoint probe so that
    ...
    # 4. Active endpoint metadata for truly custom/unknown endpoints.
