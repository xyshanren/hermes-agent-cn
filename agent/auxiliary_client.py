...
def _resolve_auto(main_runtime: Optional[Dict[str, Any]] = None) -> Tuple[Optional[OpenAI], Optional[str]]:
    ...
    runtime_base_url = str(runtime.get("base_url") or _RUNTIME_MAIN_BASE_URL)
    runtime_api_key = runtime.get("api_key", _RUNTIME_MAIN_API_KEY)
    runtime_api_mode = str(runtime.get("api_mode") or _RUNTIME_MAIN_API_MODE)
