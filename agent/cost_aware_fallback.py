...
Restored 2026-09-19: the module was lost in the v0.19.1/v0.20.0 base-bump
rewrite while its consumer contract (``agent.routing_decision`` +
``routing_decision_out`` kwarg) survived; ported verbatim from the
v0.17.0+cn.21 implementation.
"""
