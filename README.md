...
| 国内渠道 | 国外渠道（配置入口已隐藏） |
|---------|--------------------------|
| 钉钉、飞书、企业微信、微信、QQBot、元宝 | Telegram、Discord、Slack、WhatsApp 等 12 个 |

> 国外渠道代码保留（+23/-5 行改动），上游合并零冲突。详情见 [ARCHITECTURE.md](docs/ARCHITECTURE.md#42-为什么-cn-分支过滤-provider)。
